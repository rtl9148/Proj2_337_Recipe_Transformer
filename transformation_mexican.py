...
mexican_add = { ##"cilantro" : [],
                "avocado and jalapeno peppers" : ["chicken","chicken breast", "steak", "tenderloin", "sirloin", "filet mignon", "flank", "t-bone steak","beef", \
...
mexican_fallback_sentence = ['microwave 1 pouch instant brown rice & serve alongside recipe']
