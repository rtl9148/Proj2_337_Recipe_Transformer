...
to_healthy_modification = {
    ...
    "low sodium":  ["fish sauce", "soy sauce", "balsamic vinaigrette", "miso paste", "pimento-stuffed green olives", "can chopped tomatoes in puree", \
                    ...
                    "condensed cream of mushroom soup", "can condensed cream of mushroom soup", "Italian-style salad dressing", "Bavarian-style sauerkraut, undrained", "balsamic vinaigrette salad dressing, or to taste", "condensed cream of celery soup", "dry brown gravy mix", "bottle soy sauce"],
